...
- commit with a message like _prepare v0.4.6_
...
- name the post like: **VS Code xPack extension v0.4.6 pre-release**
...
- commit with a message like **VS Code xPack extension v0.4.6 pre-release**
- push
...
- commit with a message like **VS Code xPack extension v0.4.6 release**
- select the `master` branch
- merge `develop`
- push both branches
- wait for CI job to complete
...
- paste the release name like **VS Code xPack extension v0.4.6 released**
