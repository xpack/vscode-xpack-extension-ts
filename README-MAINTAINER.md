...
- commit with a message like _prepare v0.4.7_
...
- name the post like: **VS Code xPack extension v0.4.7 pre-release**
...
- commit with a message like **VS Code xPack extension v0.4.7 pre-release**
- push
...
- paste the release name like **VS Code xPack extension v0.4.7 released**
