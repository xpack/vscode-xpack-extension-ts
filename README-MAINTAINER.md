...
- name the post like: **xPack VSCode extension v0.1.0 pre-release**
...
- commit with a message like **xPack VSCode extension v0.1.0 pre-release**
- push
...
- commit with a message like **xPack VSCode extension v0.1.0 release**
- select the `master` branch
- merge `develop`
- push both branches
- wait for CI job to complete
...
- paste the release name like **xPack VSCode extension v0.1.0 released**
