...
- commit with a message like _prepare v0.4.9_
...
- name the post like: **VS Code xPack extension v0.4.9 pre-release**
...
- commit with a message like **VS Code xPack extension v0.4.9 pre-release**
- push
...
- commit with a message like **VS Code xPack extension v0.4.9 released**
- select the `master` branch
- merge `develop`
- push both branches
- wait for CI job to complete
...
- paste the release name like **VS Code xPack extension v0.4.9 released**
