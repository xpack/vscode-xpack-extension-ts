...
* 737192f move configurations in config
* a0e3820 settings.json update
* dbd9cf9 package*.json bump deps

## 2026-02-17

* ff0fc4e 1.2.0
* cc08dfe 1.2.0
* c5fe117 README update
* 74f5d6d package.json: bump vscode engine
* 925f1a0 prepare v1.2.0
