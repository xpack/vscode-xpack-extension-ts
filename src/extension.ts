...
import { NpmScriptsTreeDataProvider } from './lib/tree-view-actions'
import {
...
export async function activate (
  ...
  const commandGreeting = vscode.commands.registerCommand('xpack.greeting',
    async () => {
      // This code will be executed every time your command is executed

      // Display a message box to the user
      await vscode.window.showInformationMessage(
        'Greetings from the xPack C/C++ Managed Build!')
    })
